        ...
        <div class="container flex justify-center text-center py-20">
            <div>
                ...
                <button data-modal-target="request-modal" data-modal-toggle="request-modal"
                    class="mt-5 bg-primary px-4 py-2 rounded"
                    type="button">
                    SEND A REQUEST
                </button>
            </div>
                        ...
                        <form action="{{ route('vendor_request') }}" method="post">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div >
                                    ...
                                    <input class="px-2 py-1 w-full border rounded-md" type="text" name="name" id="name" placeholder="Enter name" required value="{{ old('name') }}" >
                                </div>
                                <div>
                                    <label for="email">Email <span class="text-red-600">*</span></label>
                                    <input type="text" class="px-2 py-1 w-full border rounded-md" name="email" id="email" placeholder="Enter email" required value="{{ old('email') }}">
                                </div>
                                <div>
                                    <label for="phone">Phone <span class="text-red-600">*</span></label>
                                    <input type="text" class="w-full px-2 py-1 border rounded-md " name="phone" id="phone" placeholder="Enter Phone number" required value="{{ old('phone') }}">
                                </div>
                                <div>
                                    <label for="shop_name">Shop Name <span class="text-red-600">*</span></label>
                                    <input type="text" class="w-full px-2 py-1 border rounded-md" name="shop_name" id="shop_name" placeholder="Enter Shop name" required value="{{ old('shop_name') }}">
                                </div>
                                <div class=" text-center col-span-2">
                                    <button type="submit" class="bg-primary px-2 py-2 text-white border rounded-md">SEND REQUEST</button>
                                </div>
                            </div>
                        </form>
                        </div>
